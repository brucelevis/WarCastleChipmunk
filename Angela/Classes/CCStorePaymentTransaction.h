...
#ifndef __HelloCpp__CCStorePaymentTransaction__
#define __HelloCpp__CCStorePaymentTransaction__
...
#endif /* defined(__HelloCpp__CCStorePaymentTransaction__) */
